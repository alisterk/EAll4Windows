...
namespace MiWindows
{
    public class MiStateExposed
    {
        private MiState _state;
        //private byte[] accel = new byte[] { 0, 0, 0, 0, 0, 0 },
        //    gyro = new byte[] { 0, 0, 0, 0, 0, 0 };

        public MiStateExposed()
        {
            _state = new MiState();
        }
        public MiStateExposed(MiState state)
        {
            _state = state;
        }

        bool A { get { return _state.A; } }  
        bool B { get { return _state.B; } }  
        bool X { get { return _state.X; } }  
        bool Y { get { return _state.Y; } } 
        ...
        bool LS { get { return _state.LS; } }  
        bool R1 { get { return _state.R1; } }  
        bool RS { get { return _state.RS; } } 
        bool Back { get { return _state.Back; } }  
        bool Menu { get { return _state.Menu; } }  
        bool HomeSimulated { get { return _state.HomeSimulated; } }  
